...
insert into APP_USER(ID, PASSWORD, USERNAME, AVATAR) values(2, '$2a$10$kfzELyfSBvY9cIBkosSRLezFRa7FIFiPouwRmkz2G6rZa70FT3eOG', 'igor', 'https://api.adorable.io/avatars/200/Tamela-Desantis'); -- root
insert into APP_USER(ID, PASSWORD, USERNAME, AVATAR) values(3, '$2a$10$kfzELyfSBvY9cIBkosSRLezFRa7FIFiPouwRmkz2G6rZa70FT3eOG', 'sofia', 'https://api.adorable.io/avatars/200/Tamela-Desantis'); -- root
